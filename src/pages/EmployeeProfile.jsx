        ...
        <div className="flex flex-col gap-6 pb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <div className="flex items-center gap-2 text-sm text-slate-500 mb-1">
                        <button onClick={() => navigate('/employees')} className="hover:text-primary transition-colors flex items-center gap-1">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="text-right shrink-0">
                        ...
                        <p className="text-3xl font-bold text-slate-800 dark:text-white">
                            {typeof employee.salary === 'number' ? `$${employee.salary.toLocaleString()}` : employee.salary || '$0.00'}
                        </p>
                ...
                <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
                    ...
                    <div className="space-y-5">
                        <div className="flex justify-between items-center">
                            ...
                            <span className="text-sm font-bold text-slate-800 dark:text-white">{financialSnapshot?.grossYTD || '$0.00'}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Taxes YTD</span>
                            <span className="text-sm font-bold text-rose-500">{financialSnapshot?.taxesYTD || '$0.00'}</span>
                        </div>
                        <div className="flex justify-between items-center">
                            <span className="text-sm text-slate-600 dark:text-slate-400">Benefits/Other</span>
                            <span className="text-sm font-bold text-rose-500">{financialSnapshot?.benefits || '$0.00'}</span>
                        </div>
                        ...
                        <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-lg font-bold text-slate-800 dark:text-white">{financialSnapshot?.netTakeHome || '$0.00'}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                ...
                <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between text-sm text-slate-500">
                    <span>Showing {payrollHistory.length} pay periods</span>
                    <div className="flex gap-2">
                        ...
                        <button onClick={() => toast('Pagination coming soon', 'info')} className="px-3 py-1 border border-slate-200 dark:border-slate-700 rounded hover:bg-slate-50 dark:hover:bg-slate-800">Next</button>
                    </div>
                </div>
            </div>
        </div>
